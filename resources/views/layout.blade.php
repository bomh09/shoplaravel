							...
							@foreach ($cat_product as $key=>$cat)
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a href="{{URL::to('/cat-product/'.$cat->cat_product_id)}}">{{$cat->cat_product_name}}</a></h4>
									</div>
								</div>
							@endforeach
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									@foreach ($brand_product as $key=>$brand)
										<li><a href="{{URL::to('/brand-product/'.$brand->brand_product_id)}}"> <span class="pull-right">(5)</span>{{$brand->brand_product_name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
