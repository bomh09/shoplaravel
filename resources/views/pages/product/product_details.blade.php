...
<div class="col-sm-9 padding-right">
        ...
        <div class="product-details"><!--product-details-->
            ...
            <div class="col-sm-7">
                <div class="product-information"><!--/product-information-->
                    ...
                    <p><b>Thương hiệu:</b> {{$details->brand_product_name}}</p>
                    <p><b>Danh mục:</b> {{$details->cat_product_name}}</p>
    ...
    <div class="recommended_items"><!--recommended_items-->
        ...
        <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active">	
                    @foreach ($related_product->take(4) as $key=>$related)
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <a href="{{URL::to('/product-details/'.$related->product_id)}}">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>{{number_format($related->product_price).' VNĐ'}}</p>
                                            <form action="{{URL::to('/save-cart')}}" method="post">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="product_id_hidden" value="{{$related->product_id}}">
                                                <button class="btn btn-default add-to-cart" type="submit"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                                            </form>
                                        </div>
                                    </div>
                                </a>
